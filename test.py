...
#that input in the variable userName. In this case, the users log-in name is stored in the variable.
...
if(userName.lower() == "ryan" and userPassword == "Pa$$w0rd!"):
...
# take whatever string is provided to it, and make it all lowercase. So, if
# I were to run the command HELLO.lower() the output would be `hello` in all
